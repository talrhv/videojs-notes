...
(function (global, factory) {
  ...
  function hideAllTooltips() {
    globalActiveTooltips.forEach(tooltip => {
    ...
    globalActiveTimeouts.forEach(timeout => {
  ...
  class NoteMarkersProgressBarControl extends Component {
    ...
    cleanup() {
      ...
      this.activeTooltips.forEach(tooltip => {
        globalActiveTooltips.delete(tooltip);
    ...
    renderMarkers() {
      ...
      this.notes.forEach(note => {
        ...
        // הוסף לרשימות הניקוי הגלובליות והמקומיות
        this.activeTooltips.add(tooltip);
        globalActiveTooltips.add(tooltip);
        ...
        const showTooltip = () => {
          // סגור כל tooltip אחר לפני פתיחת החדש
          hideAllTooltips();
  ...
  function showNoteModal(note, player) {
    // סגור כל modal קיים וכל tooltips
    closeNoteModal();
    hideAllTooltips();
  ...
  class StickyNotes extends Plugin {
    ...
    // פונקציה חדשה לסגירת כל tooltips
    hideAllTooltips() {
      hideAllTooltips();
    }
