...
(function (global, factory) {
  ...
  class StickyNotes extends Plugin {
    ...
    /* Aliases נוחים */
    addNote(n)    { this.player_.noteMarkersProgressBarControl.addNote(n); }
    updateNote(id,d){ this.player_.noteMarkersProgressBarControl.updateNote(id,d); }
    removeNote(id){ this.player_.noteMarkersProgressBarControl.removeNote(id); }
    /* optional bulk setter */
    notes(arr){
      if (Array.isArray(arr)){
        const ctrl = this.player_.noteMarkersProgressBarControl;
